...
def _require_anndata():
    try:
        ...
        raise RuntimeError(
            "AnnData handlers require the optional 'anndata' package"
        ) from exc
    return ad
...
class AnnDataHandler:
    """Packaged handler mapping AnnData into MAP's three-entity contract."""
    ...
    def _selection(
        ...
        contract = {
            ...
            "handler_backend": "map.preprocess.handlers.anndata_backend",
